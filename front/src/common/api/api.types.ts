...
export interface components {
    schemas: {
        ...
        BaseFilterContainerDto: {
            ...
            isDashMPD: boolean;
            xtags?: string;
            audioTrack?: components["schemas"]["FiltersAudioTrackDto"];
        };
        FilterVideoRangeDto: {
            start: string;
            end: string;
        ...
        FiltersResponseDto: {
            audio: components["schemas"]["BaseFilterContainerDto"][];
            video: components["schemas"]["FiltersVideoDto"][];
            both: components["schemas"]["BaseFilterContainerDto"][];
        };
        ItagsResponseDto: {
            audioItags: number[];
            videoItags: number[];
